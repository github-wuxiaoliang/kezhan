...
@Service
public class AirTravelIndexService {
    private static final String INDEX_NAME = "air_travel_index";
     ...
     */
    public PageDto<Map<String, Object>> search(AirTravelQueryDto airTravelQueryDto,int currentPage,int pageSize) throws QueryParseException, QueryException{
        List<FieldCondition> fieldConditions = airTravelQueryDto.generateFieldCondition();
     ...
     * @throws QueryException
     */
    public int count(AirTravelQueryDto airTravelQueryDto) throws QueryParseException, QueryException{
        List<FieldCondition> fieldConditions = airTravelQueryDto.generateFieldCondition();
        Query query = new LuceneQuery(INDEX_NAME, fieldConditions);
